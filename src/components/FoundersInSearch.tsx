  ...
  const allTeamMembers = [
    {
      ...
      fullDescription:
        "Peter Bai co-founded Sequence Markets and serves as CEO. He leads quantitative strategy research for market structure, trading, and low latency trading systems, and leads algorithmic development prototyping and organizational strategy. He works closely with the CTO to develop and set up backend and low latency infrastructure, including cloud computing, large language modeling research and setup, and physical co-location server building. Peter previously worked as a quant developer on the Macro Trading Desk at University Pension Plan Ontario, covering FX, equity TRS, and repo within a $13B AUM portfolio. Earlier, he was an Equity Markets quant at TMX Group focused on trading infrastructure and technology, and he spent time in venture capital at HCS Capital evaluating fintech and insurtech co-investments. Peter is an Ivey HBA student at Western University.",
    ...
    },
    {
      ...
      fullDescription:
        "Muhammad Awan serves as CTO of Sequence Markets. He owns low latency development, writing and maintaining the low latency infrastructure and turning prototypes into optimized low latency code. He works closely with the CEO to develop and set up backend and low latency infrastructure, including cloud computing, large language modeling research and setup, and physical co-location server building. Muhammad is a Founding Machine Learning Engineer at Boardy AI, building production ML systems for digital human interaction. He previously built ML pipelines at UTEX Scientific Instruments and contributed to autonomous vehicle perception at WATonomous and path planning at MIT-PITT-RW. Muhammad is a Computer Science student at the University of Waterloo.",
